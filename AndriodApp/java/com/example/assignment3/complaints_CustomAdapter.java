...
public class complaints_CustomAdapter extends RecyclerView.Adapter<complaints_CustomAdapter.MyViewHolder> {

    private Context context;
    Activity activity;

    private ArrayList id,name,cnic,matric,degree;

    complaints_CustomAdapter(Activity activity, Context context, ArrayList id,
                             ArrayList name,
                             ArrayList cnic,
                             ArrayList matric,
                             ArrayList degree){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.complaints_row,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.mainLayout_degree.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, Complaints_DetailsActivity.class);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            tvApplicantID3 = itemView.findViewById(R.id.etid3);
            tvApplicantName3 = itemView.findViewById(R.id.tvApplicantName3);
            tvApplicantCNIC3 = itemView.findViewById(R.id.etCNIC3);
            tvApplicantMatric2 = itemView.findViewById(R.id.etroom2);
            tvApplicantDegree = itemView.findViewById(R.id.tbstudentcomplaints);
