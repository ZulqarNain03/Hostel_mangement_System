...
public class applicant_CustomAdapter extends RecyclerView.Adapter<applicant_CustomAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            tvApplicantID = itemView.findViewById(R.id.etid1);
            tvApplicantName = itemView.findViewById(R.id.etname1);
            tvApplicantCNIC = itemView.findViewById(R.id.etCNIC1);
            tvApplicantEmail = itemView.findViewById(R.id.etgmail1);
            tvApplicantPhone = itemView.findViewById(R.id.etContactNo1);
            mainLayout = itemView.findViewById(R.id.mainLayout);
            applicationButton = itemView.findViewById(R.id.Roombtn);
        }
    }
}
